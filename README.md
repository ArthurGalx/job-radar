...
![Tests](https://img.shields.io/badge/testes-208%20passing-success?style=for-the-badge)
...
| 🧪 Testes automatizados (CI a cada push) | **208** |
...
- **208 testes automatizados em CI:** cada caso documenta um bug real já corrigido nesta base — não é cenário hipotético, é regressão registrada.
...
├── utils/
│ └── filtro.py
├── tests/ ← 208 casos, roda em CI a cada push
├── data/
...
208 casos parametrizados, cobrindo a camada de filtro, o parsing de callback do Telegram e o relatório de precisão — todos rodando automaticamente a cada push via GitHub Actions.
